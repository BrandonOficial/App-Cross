...
export function HistoryHeader() {
    return (
        <>
            {/* Top Bar — consistent VELOCITY branding */}
            ...
            {/* Page Title */}
            <div className="mb-5">
                <p className="text-[10px] font-bold tracking-[0.2em] uppercase text-primary mb-1">Diário de Evolução</p>
                <h2 className="text-3xl font-black tracking-tight">Treinos Passados</h2>
            </div>
        </>
    );
}
